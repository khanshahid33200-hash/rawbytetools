...
export const metadata: Metadata = {
  title: 'About Us - RawByte Tools Private Browser Utilities',
  description: 'Learn about RawByte Tools mission to provide fast, 100% private, client-side browser image and PDF processing.'
};
    ...
    <div className="min-h-screen bg-white text-slate-900 py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-extrabold text-slate-900">About RawByte Tools</h1>
